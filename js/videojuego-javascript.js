...
var game = (function () {
    ...
    function showGameOver() {
        ...
        bufferctx.fillText("PALANT :C", canvas.width / 2 - 100, canvas.height / 2);
    }

    function showCongratulations () {
        bufferctx.fillStyle="rgb(204,50,153)";
        bufferctx.font="bold 22px Arial";
        bufferctx.fillText("Enhorabuena, el poder de la pala fue efectivo!", canvas.width / 2 - 200, canvas.height / 2 - 30);
